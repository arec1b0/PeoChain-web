      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg sm:text-xl font-hammersmith text-forest/80 max-w-3xl mx-auto">
            Breaking down barriers to financial inclusion with ultra-low fees
        ...
        >
          {accessibilityFeatures.map((feature, index) => (
            ...
            >
              <div
                className={`w-20 h-20 ${feature.gradient} rounded-3xl flex items-center justify-center mx-auto mb-4 transform transition-all duration-300 group-hover:shadow-lg`}
              >
                <feature.icon className="text-white h-8 w-8" />
              </div>
              <h3 className="font-raleway font-medium text-forest mb-2">
                {feature.title}
              </h3>
              <p className="text-sm text-forest/70 font-hammersmith">
                {feature.description}
              </p>
            </motion.div>
          ))}
        ...
        >
          <Card className="bg-white/95 backdrop-blur-md border-sage/20 shadow-lg max-w-4xl mx-auto">
            <CardContent className="p-8">
              <h3 className="text-2xl font-raleway font-semibold text-forest text-center mb-8">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  <div className="text-3xl font-raleway font-bold text-sage mb-2">
                    CHF 2.8B
                  </div>
                  <div className="text-sm font-hammersmith text-forest/70">
                    Total Value Locked
