...
const Card = React.forwardRef<HTMLDivElement, CardProps>(
  (
    { className, mobileOptimized = true, ...props }: CardProps,
...
const CardHeader = React.forwardRef<HTMLDivElement, CardComponentProps>(
  (
    { className, mobileOptimized = true, ...props }: CardComponentProps,
    ref: React.ForwardedRef<HTMLDivElement>,
  ) => (
    <div
      ref={ref}
  ...
  (
    ...
    <div
      ...
      className={cn(
        ...
        mobileOptimized &&
          "text-xl sm:text-2xl touch-action-manipulation tap-highlight-transparent",
        className,
      )}
      {...props}
    />
  ...
  (
    ...
    <div
      ...
      className={cn(
        ...
        mobileOptimized &&
          "text-base sm:text-sm touch-action-manipulation tap-highlight-transparent",
        className,
      )}
      {...props}
    />
  ...
  (
    ...
    <div
      ...
      className={cn(
        "p-6 pt-0",
        mobileOptimized &&
          "p-5 sm:p-6 pt-0 touch-action-manipulation tap-highlight-transparent",
        className,
      )}
      {...props}
    />
  ...
  (
    ...
    <div
      ...
      className={cn(
        ...
        mobileOptimized &&
          "p-5 sm:p-6 pt-0 gap-3 sm:gap-4 touch-action-manipulation tap-highlight-transparent",
        className,
      )}
      {...props}
    />
