...
export default function ValidatorBonds() {
  ...
  const bondingSteps = [
    {
      ...
      description:
        "Generate validator keys using PeoChain CLI or secure key generation tools",
      icon: Key,
      details: [
    ...
    },
    {
      ...
      title: "Minimum Bond",
      description:
        "Stake the required minimum bond amount to participate in validation",
      icon: DollarSign,
      details: [
    ...
    },
    {
      ...
      description:
        "Understanding the unbonding and withdrawal timelock mechanics",
      icon: Clock,
      details: [
    ...
    },
    {
      ...
      title: "Onboarding",
      description:
        "Complete validator registration via CLI tools or web interface",
      icon: Terminal,
      details: [
  ...
  const faqItems = [
    ...
    },
    {
      id: "slashing",
      question:
        "How does the slashing mechanism work and what are the penalties?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Minimum requirements: 8-core CPU (Intel i7/AMD Ryzen 7+), 32GB RAM, 2TB NVMe SSD, 1Gbps internet connection with <50ms latency to major network hubs. Recommended setup includes redundant internet connections, UPS backup power, monitoring systems, and geographic distribution for resilience. Cloud deployment is supported on AWS, GCP, Azure with specific instance recommendations provided in our infrastructure guide.",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              <Badge
                variant="outline"
                className="px-4 py-2 text-sm border-sage text-sage"
              >
              ...
              <Badge
                variant="outline"
                className="px-4 py-2 text-sm border-medium-forest text-medium-forest"
              >
              ...
              <Badge
                variant="outline"
                className="px-4 py-2 text-sm border-dark-sage text-dark-sage"
              >
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="text-sm text-forest/70 dark:text-gray-400">
                      Active Validators
                    </div>
                  </div>
                  <div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {bondingSteps.map((step, index) => (
                <Card
                  key={step.step}
                  className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-sage/20 shadow-lg"
                >
                  <CardContent className="p-6">
                    ...
                    <ul className="space-y-1">
                      {step.details.map((detail, idx) => (
                        <li
                          key={idx}
                          className="flex items-start space-x-2 text-xs text-forest/60 dark:text-gray-500"
                        >
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-6 lg:space-y-0">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-4">
                          ...
                          <Badge
                            variant={
                              slot.status === "Active" ? "default" : "secondary"
                            }
                            className={
                              slot.status === "Active"
                                ? "bg-sage text-white"
                        ...
                        {slot.status === "Active" && (
                          <div className="space-y-2">
                            <div className="flex justify-between text-sm">
                              <span className="text-forest/70 dark:text-gray-400">
                                Capacity
                              </span>
                            ...
                            <Progress
                              value={(slot.filledSlots / slot.totalSlots) * 100}
                              className="h-2"
                            />
                          </div>
                        )}
              ...
              {faqItems.map((faq) => (
                ...
                >
                  <Collapsible
                    ...
                    onOpenChange={(open) =>
                      setExpandedFaq(open ? faq.id : null)
                    }
                  >
