...
export default function TechStackSection() {
  ...
  const techComponents = [
    ...
    },
    {
      ...
      description:
        "Multi-party signature system enabling secure operations without single points of failure",
      gradient: "bg-dark-sage",
      details: {
        overview:
          "Distributed cryptographic signatures requiring multiple validators to authorize critical operations",
        features: [
    ...
    },
    {
      ...
      description:
        "Adaptive punishment system that adjusts penalties based on network health and validator behavior",
      gradient: "gradient-sage-forest",
      details: {
        overview:
          "Intelligent slashing mechanism that maintains network integrity through economic incentives",
        features: [
  ...
  return (
    <section
      ref={sectionRef}
      id="ecosystem"
      className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-mint to-white"
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg sm:text-xl font-hammersmith text-forest/80 max-w-3xl mx-auto">
            Deep dive into the innovative technologies powering PeoChain's
            ...
            <CardContent className="p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-forest/70 font-hammersmith">
                  Real-time visualization of PeoChain's distributed validator
                  network
                </p>
              </div>
              <NetworkDiagram />
              ...
              <Card className="bg-white/95 backdrop-blur-md border-sage/20 shadow-lg transform transition-all duration-300 hover:shadow-xl">
                <Collapsible
                  ...
                  onOpenChange={(open: boolean) =>
                    setExpandedComponent(open ? component.id : null)
                  }
                >
                      ...
                      <CardContent className="p-8 w-full">
                        <div className="flex items-center justify-between">
                          <div className="flex items-start space-x-6">
                            <div
                              className={`w-16 h-16 ${component.gradient} rounded-2xl flex items-center justify-center flex-shrink-0`}
                            >
                      ...
                      <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div>
                          ...
                          <ul className="space-y-2">
                            {component.details.features.map((feature, idx) => (
                              <li
                                key={idx}
                                className="flex items-start space-x-2 text-sm text-forest/70"
                              >
                                <div className="w-1.5 h-1.5 bg-sage rounded-full mt-2 flex-shrink-0"></div>
                                <span className="font-hammersmith">
                                  {feature}
                                </span>
                              </li>
                            ))}
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            {Object.entries(component.details.metrics).map(
                              ([metric, value]) => (
                                <div
                                  key={metric}
                                  className="bg-mint/30 rounded-lg p-4 text-center"
                                >
        ...
        >
          {[
            ...
            },
            {
              ...
              color: "text-medium-forest",
            },
            {
              icon: Layers3,
              label: "Modular Architecture",
              color: "text-dark-sage",
            },
            {
              icon: Lock,
            ...
            >
              ...
              <div className="text-sm font-hammersmith text-forest/70">
                {tech.label}
              </div>
            </motion.div>
          ))}
