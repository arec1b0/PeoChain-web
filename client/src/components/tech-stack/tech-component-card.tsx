          ...
          <div className="p-6">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-forest/80 leading-relaxed">{description}</p>
              </div>
            </div>
            ...
            <Collapsible open={isExpanded} onOpenChange={handleToggle}>
              ...
              >
                <div className="pt-4 space-y-4">
                  <div>
                    <h4 className="font-semibold text-dark-forest mb-2">Overview</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-dark-forest mb-2">Key Features</h4>
                    <ul className="space-y-1">
                      {details.features.map((feature, idx) => (
                        <li key={idx} className="text-forest/80 text-sm flex items-start gap-2">
                  ...
                  <div>
                    <h4 className="font-semibold text-dark-forest mb-2">Metrics</h4>
                    <div className="grid grid-cols-2 gap-3">
                      {Object.entries(details.metrics).map(([key, value]) => (
                        <div key={key} className="bg-sage/5 rounded-lg p-3">
                          <div className="text-xs text-forest/60 mb-1">{key}</div>
