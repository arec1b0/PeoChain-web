...
export const coreFeatures: readonly CoreFeature[] = [
  {
    ...
    description:
      "Revolutionary consensus mechanism that rewards collaborative validation and network growth",
    metric: "99.9% Uptime",
  ...
  },
  {
    ...
    description:
      "Industry-leading transaction costs making DeFi accessible to everyone globally",
    metric: "USD 0.04",
  ...
  },
  {
    ...
    description:
      "Unprecedented throughput with instant finality for real-time applications",
    metric: "100K TPS",
  ...
  },
  {
    ...
    description:
      "AI-powered scoring system that rewards network participants based on their contributions",
  ...
  },
  {
    ...
    description:
      "Seamless integration with popular mobile payment systems worldwide",
    metric: "M-Pesa & GCash",
    gradient: "bg-medium-forest",
    details: [
  ...
  },
  {
    ...
    description:
      "Trustless interoperability with major blockchain networks and traditional systems",
    metric: "15+ Networks",
    gradient: "bg-dark-sage",
    details: [
