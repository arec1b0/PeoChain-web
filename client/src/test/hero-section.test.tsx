...
describe('HeroSection', () => {
  ...
  it('renders action buttons with correct labels', () => {
    ...
    expect(screen.getByRole('button', { name: /join validator network/i })).toBeInTheDocument();
    expect(screen.getByRole('button', { name: /experience testnet/i })).toBeInTheDocument();
    expect(screen.getByRole('button', { name: /read whitepaper/i })).toBeInTheDocument();
  });
  ...
  it('handles button clicks correctly', async () => {
    ...
    const validatorButton = screen.getByRole('button', { name: /join validator network/i });
  ...
  it('handles testnet button click', async () => {
    ...
    const testnetButton = screen.getByRole('button', { name: /experience testnet/i });
  ...
  it('has proper semantic structure', () => {
    ...
    expect(section || screen.getByText(/solving the/i).closest('section')).toBeInTheDocument();
  });
  ...
  it('supports keyboard navigation', async () => {
    ...
    const firstButton = screen.getByRole('button', { name: /join validator network/i });
    const secondButton = screen.getByRole('button', { name: /experience testnet/i });
