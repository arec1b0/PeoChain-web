...
export const faqItems: FaqItem[] = [
  {
    ...
    answer:
      "A validator is a network participant who validates transactions and produces blocks in the PeoChain network. Validators stake PEO tokens and earn rewards for maintaining network security and consensus.",
  },
  {
    id: "minimum-requirements",
    question: "What are the minimum technical requirements?",
    answer:
      "Validators need a dedicated server with minimum 8 CPU cores, 32GB RAM, 1TB SSD storage, and stable internet connection. The server should have 99.9% uptime to avoid slashing penalties.",
  },
  {
    id: "slashing-conditions",
    question: "What are the slashing conditions?",
    answer:
      "Slashing occurs for: double signing (5% penalty), extended downtime over 24 hours (1% penalty), and malicious behavior (up to 100% penalty). Validators can implement monitoring to prevent accidental slashing.",
  },
  {
    id: "reward-structure",
    question: "How are validator rewards calculated?",
    answer:
      "Rewards are based on: base staking rewards (6-8% APR), transaction fees (variable), and performance bonuses. Higher stake and better uptime result in proportionally higher rewards.",
  },
  {
    id: "unbonding-process",
    question: "How does the unbonding process work?",
    answer:
      "Unbonding takes 21 days on mainnet (24 hours on testnet). During this period, tokens are locked and don't earn rewards. Validators can partially unbond while maintaining minimum stake requirements.",
  },
];
