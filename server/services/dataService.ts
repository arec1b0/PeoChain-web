    ...
    if (!data) {
      data = {
        hero: {
          ...
          description:
            "PeoChain delivers 100,000+ TPS, 1-second finality, and $0.04 transaction fees while maintaining true decentralization through our revolutionary Proof of Synergy consensus mechanism.",
          metrics: {
            tps: 100000,
            finality: 1,
            transactionFee: 0.04,
  ...
  getWhitepaperData() {
    ...
    if (!data) {
      data = {
        ...
        abstract:
          "This whitepaper presents PeoChain's innovative approach to solving the blockchain trilemma through Proof of Synergy consensus, enabling unprecedented scalability while maintaining security and decentralization.",
        citations: 47,
        downloads: 12847,
      };
      cache.set(cacheKey, data);
    ...
    if (!data) {
      data = {
        consensus: {
          ...
          description:
            "Revolutionary consensus combining PoS efficiency with enhanced security",
          features: [
    ...
    if (!data) {
      ...
      data = {
        overview: {
          ...
          description:
            "Secure the network and earn rewards through validator staking",
          minimumStake: 10000,
          currentAPY: 12.5,
          bondingPeriod: 21,
          unbondingPeriod: 21,
        ...
        faq: [
          {
            ...
            answer:
              "Brief downtime results in missed rewards. Extended downtime may trigger slashing penalties proportional to the duration and network impact.",
          },
          {
            question: "Can I unstake my tokens at any time?",
            answer:
              "Yes, but there's a 21-day unbonding period during which your tokens remain locked and you won't earn rewards.",
          },
          {
            question: "How are validator rewards calculated?",
            answer:
              "Base rewards depend on your stake proportion and network participation. Performance bonuses are awarded for high uptime and quick block validation.",
          },
        ],
      };
      cache.set(cacheKey, data);
    ...
    if (!data) {
      data = {
        overview: {
          ...
          description:
            "Lightning-fast, low-cost payments powered by PeoChain technology",
