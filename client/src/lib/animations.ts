...
export const transitionPresets = {
  fast: {
    duration: parseFloat(designTokens.animation.duration.fast.replace('ms', '')) / 1000,
    ease: designTokens.animation.easing.out
  },
  normal: {
    duration: parseFloat(designTokens.animation.duration.normal.replace('ms', '')) / 1000,
    ease: designTokens.animation.easing.inOut
  },
  slow: {
    duration: parseFloat(designTokens.animation.duration.slow.replace('ms', '')) / 1000,
    ease: designTokens.animation.easing.out
  },
  spring: {
...
export function useAccessibleAnimation(
  ...
  const transition: Transition = {
    duration: parseFloat(designTokens.animation.duration[config.duration].replace('ms', '')) / 1000,
...
export class AnimationOrchestrator {
  ...
  async startAnimation(id: string, animationFn: () => Promise<void>): Promise<void> {
