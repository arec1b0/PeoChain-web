...
import { useKeyboardNavigation, useReducedMotion } from '@/hooks/use-accessibility';
...
const ActionButton = memo<{
  ...
  const ariaLabel = action.ariaLabel || `${action.label} - ${action.type === 'primary' ? 'Primary action' : 'Secondary action'}`;
